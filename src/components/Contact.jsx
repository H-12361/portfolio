...
const handleSubmit = async () => {
    ...
    setLoading(true);
    await axios.post(`${API_BASE}/contacts/contact`, form)
      .then(() => {
        setSubmittedData({ name: form.name, message: form.message }
        ); 
        ...
        setSubmitted(true);
        setForm({ name: "", email: "", message: "" });
        cosole.log("Contact info saved and emails sent successfully.");
      })
      .catch(() =>{ setError("Failed to send. Please email me directly.")
